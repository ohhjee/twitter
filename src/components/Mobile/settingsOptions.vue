<template>
  <div class="mt-3 space-y-3">
    <div class="account mx-[2px]">
      <router-link to="#" class="space-x-3 flex items-center">
        <div class="icon">
        ...
        <div class="text">
          <div class="text-details">
            ...
            <p class="m-0 text-black text-[11px]">
    ...
    <div class="account mx-[2px]">
      <router-link to="#" class="space-x-3 flex items-center">
        <div class="icon">
          <LockClosedIcon class="w-8 h-8 text-gray-600" />
        </div>
        <div class="text">
          <div class="text-details">
            <h2 class="font-bold">Security and account access</h2>
            <p class="m-0 text-black text-[11px]">
    ...
    <div class="account mx-[2px]">
      <router-link to="#" class="space-x-3 flex items-center">
        <div class="icon">
          <CashIcon class="w-8 h-8 text-gray-600" />
        </div>
        <div class="text">
          <div class="text-details">
            <h2 class="font-bold">Monetisation</h2>
            <p class="m-0 text-black text-[11px]">
    ...
    <div class="account mx-[2px]">
      <router-link to="#" class="space-x-3 flex items-center">
        <div class="icon">
          <ShieldCheckIcon class="w-8 h-8 text-gray-600" />
        </div>
        <div class="text">
          <div class="text-details">
            <h2 class="font-bold">Privacy and safety</h2>
            <p class="m-0 text-black text-[11px]">
    ...
    <div class="account mx-[2px]">
      <router-link to="#" class="space-x-3 flex items-center">
        <div class="icon">
          <BellIcon class="w-8 h-8 text-gray-600" />
        </div>
        <div class="text">
          <div class="text-details">
            <h2 class="font-bold">Notifications</h2>
            <p class="m-0 text-black text-[11px]">
             Select the kinds of notification you get about your activities, interest and recommendations.
            </p>
          </div>
        </div>
      </router-link>
    ...
    <div class="account mx-[2px] ">
      <router-link to="/Display" where_to_chanage_color class="space-x-3 flex items-center">
        ...
        <div class="text">
          <div class="text-details">
            <h2 class="font-bold">Accessibility, display and language</h2>
            <p class="m-0 text-black text-[11px]">
    ...
    <div class="account mx-[2px] flex items-center">
      <router-link to="#" class="flex space-x-3 items-center">
        <div class="icon">
          <DotsCircleHorizontalIcon class="w-8 h-8 text-gray-600" />
        </div>
        <div class="text">
          <div class="text-details">
            <h2 class="font-bold">Additional resources</h2>
            <p class="m-0 text-black text-[11px]">
